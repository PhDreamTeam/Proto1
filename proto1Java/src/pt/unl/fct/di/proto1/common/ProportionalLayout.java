package pt.unl.fct.di.proto1.common;
...
/**
 * Proportional layout - � como um border Layout mas com propor��es. Por
 * exemplo: a parte north tem 20% de extens�o vertical... Os componentes s�o
 * ent�o colocados de acordo com a proporcionalidade indicada. Este layout
 * considera os insets do container e pode adicionar seus insets que s�o
 * proporcionais. Considera hgap e vgap, como pixels or proporcionais
 * 
 * By: Ant�nio Te�filo, em desenvolvimento
 */
...
public class ProportionalLayout implements LayoutManager2 {
	 ...
	 *            utilizar. 1.0f � relativo a metade da dimens�o da frame.
	 *            ALTERADO PARA 1.0f CORRESPONDE A 100% DA DIMENS�O DA FRAME
	 */
